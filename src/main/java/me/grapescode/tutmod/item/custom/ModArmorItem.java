package me.grapescode.tutmod.item.custom;

import com.google.common.collect.ImmutableMap;
import me.grapescode.tutmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private void AddStatusEffect(PlayerEntity player, ArmorMaterial mapArmorMaterial, StatusEffectInstance mapStatusEffect) {
        ...
        if(HasCorrectArmor(mapArmorMaterial, player) && !hasPlayerEffect) {
    ...
    private boolean HasCorrectArmor(ArmorMaterial material, PlayerEntity player) {
        ...
        return helmet.getMaterial() == material && breastplate.getMaterial() == material && breastplate.getMaterial() == material && leggings.getMaterial() == material && boots.getMaterial() == material;
    }
